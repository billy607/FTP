...
public:
    CryptoImpl();
    CryptoImpl(unsigned char *remotePubKey, size_t remotePubKeyLen);
    ...
    int aesDecrypt(const unsigned char *encryptedMessage, size_t encryptedMessageLength, unsigned char **decryptedMessage);
...
private:
    ...
    unsigned char *aesKey = (unsigned char *)"b8e44d64ca8046909f3a64b3d8390f95";
    unsigned char *aesIv = (unsigned char *) "00a194b59ce1ba42cb918ea5f1816042";
